...
<?php include 'header.php';?>
    ...
    <div class="wrapper image-wrapper bg-image page-title-wrapper inverse-text" data-image-src="style/images/bg9.jpg">
      <div class="container inner text-center">
        ...
        <h1 class="page-title">We are Four Phoenix</h1>
      </div>
      <!-- /.container -->
    </div>
    <!-- /.wrapper -->
      ...
      <div class="container inner">
        <div class="row align-items-center">
          <div class="col-lg-6 text-center">
            <div class="img-blob blob8"><img src="style/images/about2.jpg" style="width: 30rem" alt="" /></div>
          </div>
          <!--/column -->
          <div class="space30 d-none d-md-block d-lg-none"></div>
          <div class="col-lg-6 pl-60 pl-md-15">
            <h2 class="title-color color-gray">About Us</h2>
            <p>Four Phoneix is one of Chennai's leading digital marketing firms. Our journey began in September of 2021. We've had good number of clients since then, and we've helped them create their web presence.</p>
            <p>We have a small but dedicated team with years of expertise and certification as digital marketing professionals.</p>
            <p>We believe in Data-Driven Digital Marketing and follow a stringent White-Hat Techniques and Anti-Spam Policy.</p>
          </div>
          <!--/column -->
        </div>
        <!--/.row -->
        ...
        <div class="row gutter-40">
          <div class="col-lg-4">
            <h4>Our Goals</h4>
            <p>To establish ourselves as a global leader in digital marketing. To help small businesses identify easy, effective, and cost-effective marketing methods and techniques. To assist firms with brand development and other digital marketing services.</p>
          </div>
          <!--/column -->
          <div class="space30 d-none d-md-block d-lg-none"></div>
          <div class="col-lg-4">
            <h4>Our Purpose</h4>
            <p>Our objective is to assist all businesses by enhancing their global web presence. Your business will be out of business if it is not on the internet in today's digital age. We're here to change the game for all small, medium, and large businesses by exposing them to a global audience.</p>
          </div>
          <!--/column -->
          <div class="space30 d-none d-md-block d-lg-none"></div>
          <div class="col-lg-4">
      ...
      <div class="container inner">
        <div class="row align-items-center">
          <div class="col-lg-6 pr-60 pr-md-15">
            <h3 class="display-3">Why the name "Four Phoenix"?</h3>
            <p>Four Phoenix assists its clients in outranking their competition in the digital race.</p>
            <p>Our logo features a phoenix bird, which signifies that we will begin and complete our work, even if we are completely destroyed.</p>
            <p>Our courage and determination enable us to accomplish this in a more effective manner.</p>
            <p>Starting a new beginning is a common occurrence, but raising and winning new things is like floating through the air without any restrictions.</p>
            ...
            <div class="carousel owl-carousel clients gap-small text-center mb-0" data-margin="30" data-loop="true" data-autoplay="true" data-autoplay-timeout="3000" data-responsive='{"0":{"items": "1"}, "768":{"items": "1"}, "992":{"items": "1"}, "1140":{"items": "1"}}'>
              <div class="item">
                ...
                <div class="blockquote-details justify-content-center">
                  ...
                  <p>I'm a professional digital marketer for the past 5years. I have completed my MBA degree. Like everyone, I also faced much negativity in my life. Only degradation I heard still now. Even though it hurts I have overcome all those things and I felt very proud of myself when I got my first job. Of course, it was a usual thing but it gives me more and confidence. And I broke down all women obstacles in the way of my career and I felt my own and real happiness through this way. My company is not just a brand it's my lifetime pride.</p>
                </blockquote>
              </div>
              <!-- /.item -->
              <div class="item">
                ...
                <div class="blockquote-details justify-content-center">
                  ...
                  <p>I'm engineering holder specialist in computer science. As per women life my life also engaged with family commitments like marriage, children. But I love my career. So it gives me more interest to choose this digital marketing field. Still I'm learning lot of new things in my day to day life as well as in digital marketing field.</p>
                </blockquote>
              </div>
              <!-- /.item -->
              <div class="item">
                ...
                <div class="blockquote-details justify-content-center">
                  ...
                  <p>I have completed my BFA degree and I'm well versed in manual, portrait, historical art as well as digital art. And I secured best student of academic year 2018-2020. It shows my love about my passion. And I won many first prizes in SVEEP fine art competition and it was conducted by er election commission of India, poompuhar gen next completion and it was conducted by tamilnadu government in the year of 2019. Due to this talent, I can able to give unique hand sketch designs. It gives reality to what clients imagination. I'm happy to say I can do my work as much I love thats why I got a expected result. I truste myself and I love my work.</p>
                </blockquote>
              </div>
              <!-- /.item -->
              <div class="item">
